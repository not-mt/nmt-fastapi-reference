...
from app.routers.v1.health import get_health_service
from app.services.v1.health import AppHealthService
...
@pytest.mark.asyncio
@patch("app.routers.v1.health.check_app_readiness", return_value=True)
...
@pytest.mark.asyncio
@patch("app.routers.v1.health.check_app_readiness", return_value=False)
